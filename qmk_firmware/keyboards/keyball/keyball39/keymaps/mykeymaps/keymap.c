...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT     , KC_LALT , KC_TAB ,KC_LALT      ,LCMD(KC_SPC) , LT(1,KC_LNG2), LT(1,KC_LNG1), RCMD(KC_SPC)  , _______      , _______     , _______  , KC_RSFT
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    KC_LCAP , KC_0 , KC_SLSH, KC_LALT, _______    , LCMD_T(KC_SPC) , RCMD_T(KC_SPC) , _______ , _______   , _______   , _______   , KC_BSLS
  ),
